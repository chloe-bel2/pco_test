...
url = "http://localhost:8001/data/comp"  # Remplacez par l'URL de votre API
...
plt.xticks(np.arange(2), ("non_Comp", "Comp"))
...
'''with mlflow.start_run(run_name="model_metrics_train") as run:
    ...
    mlflow.log_param("n_estimators_rfc_2", best_n_estimators)
